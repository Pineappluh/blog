...
The very best startup ideas tend to have three things in common: the service is something the founders themselves want (previous point), that they can build it (product risk), and that few others realize it's worth doing (customer risk).
